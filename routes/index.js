...
router.get('/', function(req, res, next) {
    ...
    //res.send(output);
    res.render('index', {title: 'csearch', countries: all_countries });
...
router.post('/', function(req, res, next) {
   ...
   console.log('stuff has been posted');

   let country = req.body.country;
   let query =req.body.keywords;
   let sublist = {};
   let contributions = {};
   ...
   // create a sublist based on query then filter by country and sort on name.
